...
let mainQuestions = [
    {
        text: 'Укажите, какова норма освещенности для работ очень высокой точности при длительной продолжительности зрительной работы:',
        right: [0],
        type: 1,
        points: 100,
        answers: ['500 лк', '200 лк', '150 лк', '400 лк',],
    },
];
...
//Несколько ответов без картинки
    ...
    nextBtn1.setAttribute('onclick', "location.href='../javascript_quiz_app_7/index.html'")
