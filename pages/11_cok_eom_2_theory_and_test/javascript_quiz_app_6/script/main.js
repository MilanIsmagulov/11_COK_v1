...
let mainQuestions = [
    {
        text: 'Выберете подходящий источник света.',
        right: [1,3],
        type: 3,
        points: 100,
        answers: ['Накаливания', 'Люминесцентная', 'Галогенная', 'Светодиодная (LED)',],
    },
];
...
//Несколько ответов без картинки
    ...
    nextBtn1.setAttribute('onclick', "location.href='../javascript_quiz_app_5/index.html'")
    ...
    nextBtn.setAttribute('onclick', "location.href='../javascript_quiz_app_7/index.html'")
